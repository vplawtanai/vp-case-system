...
const copy: Record<string,[string,string]> = {
 ...
 actualWithholding:["ยอดหัก ณ ที่จ่ายจริงจากรายการต้นทาง","Actual withholding from source transactions"],filingState:["สถานะการยื่น","Filing status"],filingOverview:["สถานะตามกำหนดยื่นรายเดือน","Status by filing month"],monthsUnit:["เดือน","months"],monthlyTrend:["กราฟยอดภาษีรายเดือน","Monthly tax amounts"],
 ...
 month:["กำหนดยื่น","Filing"],history:["ประวัติรายเดือน","Monthly history"],year:["สรุปรายปี","Year summary"],
