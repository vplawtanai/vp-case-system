...
const pageStyle = { minHeight: "100vh", padding: 24, background: "#f7f7f8", color: "#111111" };
const panelStyle = { border: "1px solid #dddddd", borderRadius: 8, background: "#ffffff", padding: 16, marginBottom: 16 };
const noAccessStyle = { ...panelStyle, color: "#a40000", background: "#fff5f5" };
const errorStyle = { ...panelStyle, color: "#a40000", background: "#fff5f5" };
const summaryGridStyle = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12, marginBottom: 16 };
const summaryCardStyle = { ...panelStyle, marginBottom: 0 };
const summaryLabelStyle = { color: "#666666", fontSize: 12, fontWeight: 700 };
const summaryValueStyle = { color: "#111111", fontSize: 24, fontWeight: 900, marginTop: 6 };
...
const labelStyle = { display: "grid", gap: 6, fontSize: 13, fontWeight: 700 };
const wideLabelStyle = { ...labelStyle, gridColumn: "1 / -1" };
const inputStyle = { padding: 10, border: "1px solid #cccccc", borderRadius: 6, fontSize: 14 };
const textareaStyle = { ...inputStyle, minHeight: 70 };
const sectionTitleStyle = { margin: "0 0 12px", fontSize: 18, fontWeight: 900 };
const actionRowStyle = { display: "flex", gap: 8, flexWrap: "wrap", marginTop: 12 };
const primaryButtonStyle = { padding: "10px 14px", border: "1px solid #111111", borderRadius: 6, background: "#111111", color: "#ffffff", cursor: "pointer", fontWeight: 800 };
const secondaryButtonStyle = { padding: "10px 14px", border: "1px solid #cccccc", borderRadius: 6, background: "#ffffff", cursor: "pointer", fontWeight: 800 };
const tableWrapStyle = { overflowX: "auto" };
const tableStyle = { width: "100%", borderCollapse: "collapse" as const, minWidth: 900 };
const thStyle = { padding: 10, borderBottom: "1px solid #dddddd", textAlign: "left" as const, fontSize: 12 };
const tdStyle = { padding: 10, borderBottom: "1px solid #eeeeee", fontSize: 13, verticalAlign: "top" as const };
const smallButtonStyle = { ...secondaryButtonStyle, padding: "6px 9px", marginRight: 6 };
const dangerButtonStyle = { padding: "6px 9px", border: "1px solid #a40000", borderRadius: 6, background: "#fff5f5", color: "#a40000", cursor: "pointer", fontWeight: 800 };
const emptyStyle = { padding: 12, border: "1px dashed #cccccc", borderRadius: 6, color: "#666666" };
