export type CompanyPurchaseTaxChoices = { vat_mode: "none" | "inclusive" | "exclusive"; vat_rate: number; wht_state: "none" | "withhold"; wht_rate: number };
export type ExpenseAccess = { user_id: string; can_claim: boolean; can_manage: boolean; can_tax_review: boolean; can_view_all: boolean; can_view_accounts?: boolean; can_record: boolean; can_confirm: boolean; is_admin: boolean; creator_payment_fact_supported?: boolean; company_declaration_without_account_supported?: boolean; company_tax_calculation_supported?: boolean; company_purchase_request_supported?: boolean; employee_reimbursement_review_supported?: boolean; can_create_company?: boolean };
...
export function expenseError(error: unknown) {
 ...
 if (/EXPENSE_REQUEST_PAYEE_REQUIRED/.test(message)) return "purchaseRequestPayeeRequired";
 if (/EXPENSE_REQUEST_REVIEW_REQUIRED/.test(message)) return "purchaseRequestReviewRequired";
