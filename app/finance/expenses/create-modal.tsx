...
export function ExpenseCreateModal({ onClose, error, ...form }: Props) {
 ...
 return <>
  <DetailModal variant="review" open size="workflow" title={t(form.claim ? "expenses.newClaim" : "expenses.new")} subtitle={t(form.claim ? "expenses.claimHelp" : "expenses.subtitle")}
  ...
  {confirmClose ? <DetailModal variant="destructive" open size="confirm" title={t("common.state.unsaved")} onClose={() => setConfirmClose(false)} closeOnBackdrop={false}
