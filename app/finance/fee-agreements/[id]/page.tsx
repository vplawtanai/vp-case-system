...
function billingPlanNextStepDescription(plan: BillingPlanReference | null) {
  if (!plan) return "กำหนดงวดและเงื่อนไขการเรียกเก็บเงินตามข้อตกลงค่าบริการ การสร้างแผนยังไม่เป็นการออกใบแจ้งหนี้";
