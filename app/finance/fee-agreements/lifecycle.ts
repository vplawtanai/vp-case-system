...
const statusLabels: Record<string, string> = {
  ...
  engagement_confirmed: "ยืนยันการว่าจ้างแล้ว",
  cancelled: "ยกเลิก",
...
const statusDescriptions: Record<string, string> = {
  ...
  signed: "ระบบบันทึกสถานะว่าลงนามแล้ว ขั้นตอนการดำเนินงานตามปกติคือจัดทำหรือดำเนินการตามแผนเรียกเก็บเงิน ส่วนการปิดกระบวนการเอกสารเป็นการดำเนินการแยกต่างหาก",
  completed: "ปิดกระบวนการจัดทำเอกสารแล้ว โดยไม่เปลี่ยนสถานะงาน การเรียกเก็บเงิน หรือการชำระเงิน",
  engagement_confirmed: "ลูกค้ายืนยันการว่าจ้างตามใบเสนอราคาแล้ว รายการนี้ใช้หลักฐานจากใบเสนอราคาที่ตอบรับและไม่มีสัญญาว่าจ้างแยก",
