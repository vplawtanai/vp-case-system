...
export type CashMovement = { id: string; bank_account_id: string | null; cash_location_id: string | null; occurred_at: string; cash_amount: number; currency: string; direction: string; transaction_type: string; status: string; reference_no: string | null; description: string | null; source_snapshot_json: TreasurySource | null; source_payout_id?: string | null };
