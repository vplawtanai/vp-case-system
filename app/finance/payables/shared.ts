...
export type PayableComponent = {
  ...
  bucket: "referral" | "work"; role_label: string; recipient_type: "user"; recipient_id: string; recipient_name: string;
  currency: string; gross_amount: number; finalized_at: string; status: "open" | "superseded";
