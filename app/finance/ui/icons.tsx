import { Search, ArrowDownLeft, ArrowUpRight, ArrowLeftRight, ArrowRight, Building2, CalendarClock, Check, CircleCheck, CircleAlert, Clock3, FileCheck2, FilePenLine, FileStack, FileText, HandCoins, History, Landmark, Link2, Receipt, ReceiptText, RotateCcw, ShieldCheck, Split, Wallet, X, type LucideIcon } from "lucide-react";
