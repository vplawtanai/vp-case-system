-- Combined VP-RTI post-issue verification: ONE SELECT-only statement, ONE row, NO RPCs.
...
with
k as (select true as after_issue,
...
expected_functions(name,body_md5) as (values
    ('issue_finance_combined_document','2207c2d70f98db33a2f18eabe05ca624'),
    ('generate_finance_document_no','e8930fcf469ccd9980785d55355eef47'),
    ('validate_finance_combined_document','972428305229c19520c4e9b2004aed62'),
    ('protect_finance_combined_document','8c0ed16cc4c0b5f2c387c8f73c20c2f2'),
    ('validate_finance_document_tax_integrity','d2674f68e33dd69ce59cae9bcccc7c7b'),
    ('finance_tax_invoice_issue_blockers','e7f592f622ab0494cbf15c160b2807bb'),
    ('tax_blockers_pre040','9956fcd2141247a996e3ac72600eff67'),
    ('void_finance_receipt','1899822f8a5561379cc46ce002a6b202'),
    ('cancel_finance_combined_document_draft','4844510df3eb3f68faefd73e90d1fddc'),
    ('issue_finance_receipt','04ecfe81a3c72f36587f2e7ec06f0a35'),
    ('issue_finance_tax_invoice','db1ea3f2895a8eedb121493d8af86955'),
    ('current_user_can_issue_combined_documents','4a0335e8ee913bd3a92a04930e99abad'),
    ('build_finance_receipt_source','1fe91b4d85e36bdc913b5427f5a8e270'),
    ('document_logo_evidence','a76bf15714d1c4811e7845033b4afe72'),
    ('guard_receipt_logo_issue','9483f342d1d164cc16ffd888c9381a06'),
    ('build_finance_document_tax_source','6738b2496a31ae3236145dc121f55c6c'),
    ('finance_tax_invoice_draft_snapshot','98adea2dd41c427318401559df580a84'),
    ('document_tax_source_pre042','1629c804cf013b519759d672541d7d09'),
    ('document_tax_snapshot_pre042','bef394e77841bd9e6394511f3eebc7bd')
),
function_facts as (
...
select to_jsonb(checks) as checks,
  ...
  jsonb_build_object('combined_no',s.c->'combined_no','receipt_no',s.r->'receipt_no','tax_invoice_no',s.t->'tax_invoice_no','period_counters',n.period_counters,'counter_method','Transactional table UPSERT, not a sequence; compare preflight baseline for unrelated RC/TI changes') as numbering_observability,
