...
test('G: migrations, Legacy, category/modal/lifecycle/data readers and financial calculations are unchanged',()=>{
 const files=['app/finance/expense-claims/page.tsx','app/finance/expenses/data.ts','app/finance/expenses/forms.tsx','app/finance/expenses/create-modal.tsx','app/finance/expenses/categories.ts','app/finance/FinanceSidebar.tsx',...cp.execFileSync('git',['ls-tree','-r','--name-only','HEAD','supabase/migrations'],{encoding:'utf8'}).trim().split('\n')];
