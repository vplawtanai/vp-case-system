...
function quotation(status) {
  ...
  const data={
    ...
    signer:{name:'ผู้ทดสอบ',position:'กรรมการ',email:''},showSignerSignature:false,signerSignatureUrl:'',signerSignatureImageRef:null,
  };
...
function documentHtml(type,status) {
