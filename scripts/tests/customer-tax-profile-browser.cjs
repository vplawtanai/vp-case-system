...
fs.writeFileSync(entry,`import React from 'react';import{createRoot}from'react-dom/client';import{UiLocaleProvider}from'${root}/lib/i18n/provider.tsx';import LanguageSelector from'${root}/app/components/LanguageSelector.tsx';import{CustomerTaxIdentityEditor}from'${root}/app/clients/[id]/tax-identity/page.tsx';createRoot(document.getElementById('root')).render(<UiLocaleProvider initialLocale="th" pathname="/clients/local/tax-identity"><LanguageSelector/><CustomerTaxIdentityEditor/></UiLocaleProvider>);`);
async function main(){
