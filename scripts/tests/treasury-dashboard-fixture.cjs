...
function fixture(){
 const accounts=[['KBANK','KBANK','bank',29560],['เงินสดสำนักงาน','Office Cash','cash',20000],['BAY','BAY','bank',null],['KTB','KTB','bank',null]].map(([name_th,name_en,kind,system_balance],i)=>({
  ...
  opening_id:system_balance!==null?id(i+10):null,opening_as_of:system_balance!==null?'2026-08-31T16:59:59.999999Z':null,opening_amount:i===0?0:i===1?20000:null,system_balance,inflow:i===0?29560:0,outflow:0,
 }));
