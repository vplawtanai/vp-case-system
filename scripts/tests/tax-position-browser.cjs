...
const entry=write('entry.tsx',`import React from'react';import{createRoot}from'react-dom/client';import{UiLocaleProvider}from'${root}/lib/i18n/provider.tsx';import LanguageSelector from'${root}/app/components/LanguageSelector.tsx';import TaxPositionPage from'${root}/app/finance/tax-position/page.tsx';createRoot(document.getElementById('root')).render(<UiLocaleProvider initialLocale="th" pathname="/finance/tax-position"><LanguageSelector/><TaxPositionPage/></UiLocaleProvider>);`);
async function main(){
