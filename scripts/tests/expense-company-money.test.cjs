...
test('057 workflow artifacts SELECT-only and exactly embedded; 001-056 and protected UI/contracts unchanged',()=>{
 ...
 files.push(...['company-list.tsx','company-categories.ts','company.module.css','workspace.tsx','request-view.tsx','request-operations.ts','requests.ts','data.ts'].map(p=>'app/finance/expenses/'+p),'app/finance/payouts/payee-modal.tsx');
